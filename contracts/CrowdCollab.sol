...
contract CampaignCreator {
    ...
    function createCampaign(uint minContribution, string description) public {
        address newCampaign = new CrowdCollab(msg.sender, minContribution, description);
...
contract CrowdCollab {
    ...
    function createRequest(string description, uint amount, address recipient) public managerOnly {
